...
public class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver erro htt 400 quando informacoes estao invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devolver codigo htt 200 quando informacoes estao validas")
    @WithMockUser
